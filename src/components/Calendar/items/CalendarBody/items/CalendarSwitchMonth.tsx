...
function CalendarSwitchMonth(
    ...
    return (
        <div className={`flex justify-between ${showLineIfHeadIsActive}`}>
            <button className="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-102 focus:outline-none p-2 rounded-full bg-text-white text-gray-900 shadow-md" onClick={handleLeftArrowButton }>
            ...
            <div className=" text-2xl  font-bold"> {dateUtil.getMonthFromDate()}</div>
                ...
                <button className="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-102 focus:outline-none focus:outline-none p-2 rounded-full bg-text-white text-gray-900 shadow-md" onClick={handleRightArrowButton }>
                    <svg width="15" height="15" fill="currentColor" viewBox="0 0 24 24">
                        <path fill="currentColor"
